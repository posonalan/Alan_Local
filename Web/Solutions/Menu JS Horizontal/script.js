...
//     var icon = document.getElementsByClassName("titreNav");
   
//     if (  element.addEventListener("click", clickSousMenu)) {
//       sousMenu.style.overflowY = "hidden";
//     } else {
//      sousMenu.style.overflowY = "";
//     }
//   }

  function HamburgerFonctionnel(){
/* Sélection des éléments HTML */
let row = document.getElementsByClassName('row')
let hamburger = document.getElementsByClassName('titreNav')
